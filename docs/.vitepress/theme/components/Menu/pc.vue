  ...
  >
    <ul :class="`font-mono list-none flex justify-center items-center w-7/12 h-full`">
      <li
        ...
        :class="`flex justify-center items-center p-4 transform transition-transform hover:bg-white hover:text-black hover:scale-110 hover:shadow-xl cursor-pointer ${
...
export default defineComponent({
  setup() {
    ...
    const prevScrollTop = useDebounceValue(0, 300);
    watch(scrollTop, () => {
